...
public class Handler : IRequestHandler<RegisterDeviceCommand, RegisterDeviceResponse>
{
    ...
    public Handler(IDbContext dbContext, UserManager<ApplicationUser> userManager, ChallengeValidator challengeValidator, IUserContext userContext, ILogger<Handler> logger)
    {
